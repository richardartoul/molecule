...
func (*Nested) Descriptor() ([]byte, []int) { return fileDescriptorSimple, []int{2} }
...
func init() {
	...
	proto.RegisterType((*Nested)(nil), "simple.Nested")
}
...
func (m *Nested) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NestedMessage != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintSimple(dAtA, i, uint64(m.NestedMessage.Size()))
		n5, err := m.NestedMessage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *Nested) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.NestedMessage == nil {
				m.NestedMessage = &Test{}
			}
			if err := m.NestedMessage.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorSimple = []byte{
	...
	,
}
