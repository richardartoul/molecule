...
type Simple struct {
	...
	RepeatedInt64NotPacked []int64 `protobuf:"varint,16,rep,packed,name=repeated_int64_not_packed,json=repeatedInt64NotPacked" json:"repeated_int64_not_packed,omitempty"`
}
...
func (m *Simple) GetRepeatedInt64NotPacked() []int64 {
	if m != nil {
		return m.RepeatedInt64NotPacked
	}
	return nil
}
...
func (m *Simple) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RepeatedInt64NotPacked) > 0 {
		dAtA2 := make([]byte, len(m.RepeatedInt64NotPacked)*10)
		var j1 int
		for _, num1 := range m.RepeatedInt64NotPacked {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *Simple) Size() (n int) {
	...
	if len(m.RepeatedInt64NotPacked) > 0 {
		l = 0
		for _, e := range m.RepeatedInt64NotPacked {
	...
	for iNdEx < l {
		...
		case 16:
			if wireType == 0 {
				...
				m.RepeatedInt64NotPacked = append(m.RepeatedInt64NotPacked, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field RepeatedInt64NotPacked", wireType)
			}
		default:
			iNdEx = preIndex
...
var fileDescriptorSimple = []byte{
	...
	,
}
